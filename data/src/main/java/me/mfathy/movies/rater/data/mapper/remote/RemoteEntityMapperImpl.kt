...
import me.mfathy.movies.rater.data.mapper.base.RemoteEntityMapper
...
class RemoteEntityMapperImpl @Inject constructor() :
    RemoteEntityMapper<MovieEntity, RemoteMovie> {
